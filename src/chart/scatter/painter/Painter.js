...
export default class Painter {
    ...
    _paintScatters () {
        ...
        //设置共同样式
        ctx.globalAlpha = Styles.SCATTER_POINT_ALPHA;
    ...
    _paintCross () {
        ...
        //设置样式
        ctx.lineWidth = Styles.SCATTER_CROSS_LINE_WIDTH;
        ctx.strokeStyle = Styles.SCATTER_CROSS_COLOR;

        //绘制横向
        x1 = chartInfo_In.bodyLeft;
        x2 = canvasWidth - chartInfo_In.bodyRight;
        y1 = Utility.adjustPosition(mousePosition.y);
        ...
        y1 = chartInfo_In.bodyTop;
        y2 = canvasHeight - chartInfo_In.bodyBottom;
        x1 = Utility.adjustPosition(mousePosition.x);
